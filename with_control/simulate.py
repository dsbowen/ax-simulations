"""Run "needle-in-a-haystack" simulations with a control arm.
"""
import os
import sys
...
def run_batch(i, needle, df, experiment_df, n_treatments, use_adaptive_assignment):
    ...
    if i % COLLECT_RESULTS_FREQUENCY == 0:
        best_index = LinearEmpiricalBayes(params, cov).fit().params.argmax()
...
if __name__ == "__main__":
    ...
    df = pd.concat([df[df.treatment.isin((CONTROL, needle))]] + haystacks)\
